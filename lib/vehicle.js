...
export var player = {x: 400, y: 0, jumped: false, jumping: true, direction: null, token: "start", doublejumping: false, falling: false}
...
export const init = (context) => {
  ...
  player = {x: 400, y: 0, jumping: true, direction: null, jumped: false, token: "start", doublejumping: false, falling: false}
