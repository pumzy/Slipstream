...
document.addEventListener("DOMContentLoaded", () => {
  ...
  gamebackground.src = "assets/images/background-game.png"
  ...
  const move = () => {
    ...
    for (var i = 0; i < platforms.length; i++) {
      if ( onPlatform(platforms) && (player.x > platforms[i].obstacles.x - 30 && player.x < platforms[i].obstacles.x -10) && player.y > platforms[i].obstacles.y - 30){
