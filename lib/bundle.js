...
var player = exports.player = { x: 400, y: 0, jumping: false, direction: null, token: null, doublejumping: false, falling: false };
...
var resetVehicle = exports.resetVehicle = function resetVehicle() {
  exports.player = player = { x: 400, y: 0, jumping: false, direction: null, token: "falling", doublejumping: false, falling: false };
};
...
var platforms = exports.platforms = [{ x: 200, y: 230, speed: 2, obstacles: null, powercubes: null, popped: null }, { x: 1050, y: 350, speed: 2, obstacles: null, powercubes: null, popped: null }, { x: 1050, y: 160, speed: 2, obstacles: null, powercubes: null, popped: null }, { x: 1800, y: 260, speed: 2, obstacles: null, powercubes: null, popped: null }];

var init = exports.init = function init(context) {

  if (platforms.length === 4) {
    exports.platforms = platforms = [{ x: 200, y: 230, speed: 2, obstacles: null, powercubes: null, popped: null }, { x: 1050, y: 350, speed: 2, obstacles: null, powercubes: null, popped: null }, { x: 1050, y: 160, speed: 2, obstacles: null, powercubes: null, popped: null }, { x: 1800, y: 260, speed: 2, obstacles: null, powercubes: null, popped: null }];
  }
...
var _pica = __webpack_require__(12);
...
const base64decode     = __webpack_require__(8).base64decode;
const math_wasm_base64 = __webpack_require__(17);
...
// Pin implementations
MathLib.prototype.unsharp_js = __webpack_require__(16);
MathLib.prototype.resize_js  = __webpack_require__(15);
...
const createFilters = __webpack_require__(7);
...
var FILTER_INFO = __webpack_require__(14);
...
const assign        = __webpack_require__(11);
const webworkify    = __webpack_require__(9);


const MathLib       = __webpack_require__(5);
const Pool          = __webpack_require__(18);
const utils         = __webpack_require__(8);
const worker        = __webpack_require__(20);
const createRegions = __webpack_require__(19);
...
Pica.prototype.init = function () {
  ...
  if (features.indexOf('ww') >= 0) {
    if ((typeof window !== 'undefined') && ('Worker' in window)) {
      ...
      try {
        let wkr = __webpack_require__(9)(function () {});
        wkr.terminate();
...
const createFilters        = __webpack_require__(7);
const convolveHorizontally = __webpack_require__(6).convolveHorizontally;
const convolveVertically   = __webpack_require__(6).convolveVertically;
...
var glurMono16   = __webpack_require__(10);
var getLightness = __webpack_require__(13);
