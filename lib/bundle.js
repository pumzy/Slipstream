...
var init = exports.init = function init(context) {
  ...
  context.drawImage(vehicleimg, player.x, player.y, 40, 40);
};
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var move = function move() {
    ...
    context.strokeStyle = "black";
    context.strokeRect(0, 0, width, height);
    var platform = Platform.move(context);
    var player = Vehicle.move(context);
    ...
    debugger;
    if (player.x === platform.obstacles.x - 14 && player.y > platform.obstacles.y - 30) {
...
var platform = exports.platform = { x: 200, y: 230, speed: 2, obstacles: null
  ...
  // const canvas = $("canvas")[0]
  // const context = canvas.getContext("2d")
  exports.platform = platform = { x: 200, y: 230, speed: 2, obstacles: null };
