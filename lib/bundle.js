...
exports.restartFind = exports.clearObstacles = exports.move = exports.init = exports.obstacles = exports.obstacleimage = undefined;

var _pica = __webpack_require__(11);
...
var init = exports.init = function init(context, platform, id, token) {
  ...
  if (token === "regen") {
    ...
    if (id >= 3) {
      for (var i = 0; i < calcCubes(); i++) {
        ...
        var newcube = { x: platform.x + (platform.width - i * 200), y: platform.y - 15, image: cubepic, platformID: platform.id };
        powercubes.push(newcube);
        context.drawImage(cubepic, newcube.x, newcube.y, 15, 15);
      }

      console.log(powercubes);
  ...
  for (var _i = 0; _i < calcCubes(); _i++) {
    ...
    powercubes.push({ x: platform.x + (platform.width - _i * 200), y: platform.y - 15, image: new Image(), platformID: platform.id });
  }
...
const base64decode     = __webpack_require__(5).base64decode;
const math_wasm_base64 = __webpack_require__(16);
...
// Pin implementations
MathLib.prototype.unsharp_js = __webpack_require__(15);
MathLib.prototype.resize_js  = __webpack_require__(14);
...
const createFilters = __webpack_require__(4);
...
var FILTER_INFO = __webpack_require__(13);
...
var generatePlatforms = exports.generatePlatforms = function generatePlatforms(context) {
  ...
  var newplatforms = [platforms[platforms.length - 3], platforms[platforms.length - 2], platforms[platforms.length - 1]].concat(PlatformArrays.platformGenerator(endoflast, platforms[platforms.length - 1].id));
...
const assign        = __webpack_require__(10);
const webworkify    = __webpack_require__(6);


const MathLib       = __webpack_require__(2);
const Pool          = __webpack_require__(17);
const utils         = __webpack_require__(5);
const worker        = __webpack_require__(19);
const createRegions = __webpack_require__(18);
...
Pica.prototype.init = function () {
  ...
  if (features.indexOf('ww') >= 0) {
    if ((typeof window !== 'undefined') && ('Worker' in window)) {
      ...
      try {
        let wkr = __webpack_require__(6)(function () {});
        wkr.terminate();
...
const createFilters        = __webpack_require__(4);
const convolveHorizontally = __webpack_require__(3).convolveHorizontally;
const convolveVertically   = __webpack_require__(3).convolveVertically;
...
var glurMono16   = __webpack_require__(9);
var getLightness = __webpack_require__(12);
...
var platformGenerator = exports.platformGenerator = function platformGenerator(endoflast, id) {

  var platforms = [[{ x: endoflast + 50, y: 230, speed: 2, obstacles: null, powercubes: null, popped: [], width: widthGenerator(), id: id + 1 }, { x: endoflast + 900, y: 350, speed: 2, obstacles: null, powercubes: null, popped: [], width: widthGenerator(), id: id + 2 }, { x: endoflast + 900, y: 200, speed: 2, obstacles: null, powercubes: null, popped: [], width: widthGenerator(), id: id + 3 }, { x: endoflast + 1750, y: 260, speed: 2, obstacles: null, powercubes: null, popped: [], width: widthGenerator(), id: id + 4 }], [{ x: endoflast + 60, y: 230, speed: 2, obstacles: null, powercubes: null, popped: [], width: widthGenerator(), id: id + 1 }, { x: endoflast + 910, y: 350, speed: 2, obstacles: null, powercubes: null, popped: [], width: widthGenerator(), id: id + 2 }, { x: endoflast + 1680, y: 300, speed: 2, obstacles: null, powercubes: null, popped: [], width: widthGenerator(), id: id + 3 }, { x: endoflast + 2430, y: 250, speed: 2, obstacles: null, powercubes: null, popped: [], width: widthGenerator(), id: id + 4 }]];
