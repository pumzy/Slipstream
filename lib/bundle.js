...
var init = exports.init = function init(context, platform, id, token) {
  ...
  if (token === "regen") {
    for (var i = 3; i < calcCubes(); i++) {

      powercubes.push({ x: platform.x + (platform.width - i * 200), y: platform.y - 15, image: new Image(), platformID: id });
    }

    for (var _i = 3; _i < powercubes.length; _i++) {
      var randomno = Math.floor(Math.random() * 3 + 1);
      randomno === 1 ? powercubes[_i].image.src = "assets/images/powercube_purple.png" : randomno === 2 ? powercubes[_i].image.src = "assets/images/powercube_green.png" : powercubes[_i].image.src = "assets/images/powercube_white.png";
      context.drawImage(powercubes[_i].image, powercubes[_i].x, powercubes[_i].y, 15, 15);
    }
  ...
  for (var _i2 = 0; _i2 < calcCubes(); _i2++) {

    powercubes.push({ x: platform.x + (platform.width - _i2 * 200), y: platform.y - 15, image: new Image(), platformID: id });
  }

  for (var _i3 = 0; _i3 < powercubes.length; _i3++) {
    var _randomno = Math.floor(Math.random() * 3 + 1);
    _randomno === 1 ? powercubes[_i3].image.src = "assets/images/powercube_purple.png" : _randomno === 2 ? powercubes[_i3].image.src = "assets/images/powercube_green.png" : powercubes[_i3].image.src = "assets/images/powercube_white.png";
    context.drawImage(powercubes[_i3].image, powercubes[_i3].x, powercubes[_i3].y, 15, 15);
  }
...
var move = exports.move = function move(context, platform, id, popped) {
  for (var i = 0; i < powercubes.length; i++) {
    if (id === powercubes[i].platformID && !popped.includes(powercubes[i].x)) {
      powercubes[i].x = platform.x + (platform.width - i * 200);
...
var initialPlatforms = exports.initialPlatforms = [{ x: 200, y: 230, speed: 2, obstacles: null, powercubes: null, popped: [], width: 800 }, { x: 1050, y: 350, speed: 2, obstacles: null, powercubes: null, popped: [], width: 800 }, { x: 1800, y: 300, speed: 2, obstacles: null, powercubes: null, popped: [], width: 800 }, { x: 2650, y: 250, speed: 2, obstacles: null, powercubes: null, popped: [], width: 800 }];

// Level things

var platformGenerator = exports.platformGenerator = function platformGenerator(endoflast) {

  var platforms = [[{ x: endoflast + 50, y: 230, speed: 2, obstacles: null, powercubes: null, popped: [], width: widthGenerator() }, { x: endoflast + 900, y: 350, speed: 2, obstacles: null, powercubes: null, popped: [], width: widthGenerator() }, { x: endoflast + 900, y: 200, speed: 2, obstacles: null, powercubes: null, popped: [], width: widthGenerator() }, { x: endoflast + 1750, y: 260, speed: 2, obstacles: null, powercubes: null, popped: [], width: widthGenerator() }], [{ x: endoflast + 60, y: 230, speed: 2, obstacles: null, powercubes: null, popped: [], width: widthGenerator() }, { x: endoflast + 910, y: 350, speed: 2, obstacles: null, powercubes: null, popped: [], width: widthGenerator() }, { x: endoflast + 1680, y: 300, speed: 2, obstacles: null, powercubes: null, popped: [], width: widthGenerator() }, { x: endoflast + 2430, y: 250, speed: 2, obstacles: null, powercubes: null, popped: [], width: widthGenerator() }]];
